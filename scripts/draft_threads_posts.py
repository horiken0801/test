...
from socialbot.threads_trend_drafts import DraftParseError, render_markdown, research_and_draft
...
def main() -> None:
    ...
    try:
        drafts, _raw_text = research_and_draft(config, JUKEN_CONFIG_PATH, REFERENCE_DIR)
    ...
    md_path.write_text(render_markdown(drafts, now), encoding="utf-8")
